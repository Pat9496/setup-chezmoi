...
DOTFILE_CANDIDATES=(
  ...
  "$HOME/.var/app/tv.kodi.Kodi/data/userdata/guisettings.xml"
  "$HOME/.var/app/tv.kodi.Kodi/data/userdata/keymaps"
  "$HOME/.var/app/tv.kodi.Kodi/data/userdata/profiles.xml"
